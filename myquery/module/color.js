...
myQuery.define('module/color', ['module/object', 'hash/cssColors'], function ($, object, cssColors, undefined) {
    "use strict"; //启用严格模式
    ...
    color.prototype = {
        ...
        clone: function () {
            var o = new this.constructor(), p = this._propertys, i = 0, len = p.length, arg = [];
            for (; i < len; ) {
                arg.push(this[p[i++]]);
            }
            o.init.apply(o, arg);
        ...
        // CSS RGB(A) literal:
            function (css) {
                ...
                function match(regex, max_value) {
                    var colorGroups = css.match(regex), r, g, b;
    ...
    $.easyExtend(HSV.prototype, {
        ...
        toRGB: function () {
            ...
            var i, f, p, q, t, r, g, b, h = this.hue, s = this.saturation, v = this.value;
