...
myQuery.define("html5/canvas", ["html5/canvas"], function ($, canvas, undefined) {
    "use strict"; //启用严格模式
    if (canvas) {
        var R = Math.round
        , toRGBA = function (c, a) {
        ...
        $.easyExtend(canvas.prototype, {
            ...
            , dashedLineTo: function (fromX, fromY, toX, toY, pattern) {
				...
				capmin = function (a, b) { return M.mn(a, b); },
				capmax = function (a, b) { return M.mx(a, b); },
            ...
            idx = 0, dash = true;
                while (!(checkX.thereYet(offsetX, toX) && checkY.thereYet(offsetY, toY))) {
                    var ang = M.at2(toY - fromY, toX - fromX), len = pattern[idx];
