myQuery.define("mobile/event.proxy", ["base/client", "main.event"], function ($, client, event, undefined) {
    ...
    if (client.system.mobile) {
        $.interfaces.achieve("editEventType", function (name, type) {
            var str = "";
            switch (type) {
                case "mousedown": str = "touchstart";
                    break;
                case "mousemove": str = "touchmove";
                    break;
                case "mouseup": str = "touchend";
                    break;
                default: str = type;
            }
            return str;
        ...
        , touchImitation = function () {
            ...
            , settings = i = $.extend({}, _touchSettings, paras)
            , e, i, name;

            e = createEvent("TouchEvents");
            e.initTouchEvent(type, i.bubbles, i.cancelable, i.view, i.detail
            , i.screenX, i.screenY, i.clientX, i.clientY, i.relatedTarget);
