  ...
  if ( typeof CanvasRenderingContext2D != "undefined" ) {
    ...
    utilExtend.easyExtend( canvas.prototype, {
      ...
      bc: function( a, b, c, d, e, f ) {
        this.bezierCurveTo( a, b, c, d, e, f );
        return this;
      },
      ...
      cr: function( a, b, c, d ) {
        this.clearRect( a || 0, b || 0, c || 2000, d || 2000 );
        return this;
      },
      ...
      ff: function( con, fns ) {
        fns.apply( con, [].slice.call( arguments, 2 ) );
        return this;
      },
      fg: function() {
        this.f( this.grad );
      ...
      gc: function( a ) {
        this.globalCompositeOperation = a;
        return this;
      },
