        ...
        , file: {
            ...
            , getAll: function (fun, fileSystem) {
                ...
                dirReader.readEntries(function (entries) {
                    ...
                    for (var i = 0, len = entries.length, item, result = { file: [], directory: [] }; i < len; i++) {
            ...
            , requestFileSystem: function (success, type, size) {
                var self = this;
                self.defaultFileSystem ? success(self.defaultFileSystem)
                : window.requestFileSystem(type || LocalFileSystem.PERSISTENT, size || 0, function (fileSystem) {
            ...
            , fileSettings: {
                ...
                flags: { create: true, exclusive: false }
                , onEvent: null
            ...
            , download: function (url, name, success, fail, fullPath) {
                ...
                fileTransfer.download(
                    url
                    , (fullPath || this.defaultFullPath) + "/" + name
                    , success
                    , fail
                );
            }
